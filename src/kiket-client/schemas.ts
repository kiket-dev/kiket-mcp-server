...
export const templateOnboardingRoleSchema = z.object({
  id: z.string(),
  label: z.string(),
  description: z.string(),
  mapsTo: z.enum(['developer', 'pm', 'compliance', 'executive']),
});
...
export const templateDefinitionSchema = z.object({
  ...
  boardCount: z.number(),
  issueTypeCount: z.number(),
  hasIntakeForms: z.boolean(),
  previewStates: z.array(z.string()),
  onboardingRoles: z.array(templateOnboardingRoleSchema),
  files: z.array(z.string()).optional(),
});

export const templateDefinitionListSchema = z.object({
